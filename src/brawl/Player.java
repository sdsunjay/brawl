...
public class Player
{
    ...
    public Player()
    {
        ...
        //SET discard CardStack to an empty stack
     ...
     */
    public void setDeck(Character owner, boolean flag, Integer[] quantityOfTypes)
    {
        if(quantityOfTypes!=null)
        {

            deck.createCustomDeck(quantityOfTypes,owner);
        }
